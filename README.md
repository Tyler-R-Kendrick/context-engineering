...
This repository now includes the complete **Learn-SK Prompt Engineering Workshop** materials:

- **🎯 9 comprehensive modules** covering prompt engineering from basics to advanced techniques
- **⏱️ 3+ hours** of detailed enterprise-focused content  
- **🔧 Hands-on examples** with Semantic Kernel and Microsoft AI tools
- **📊 Testing & evaluation** frameworks for prompt effectiveness
...
3. `notebooks/prompt-engineering/` - Slide-aligned companion notebooks for each prompt engineering workshop module
